...
<?php echo e($user->username); ?> <?php echo e(trans('hifone.sucscribers.list')); ?>_@parent
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <?php if(count($subscribers)): ?>
	    <?php echo $__env->make('users.partials.subscribers', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
