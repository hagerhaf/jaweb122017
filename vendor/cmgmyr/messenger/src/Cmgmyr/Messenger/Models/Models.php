...
class Models
{
	...
	public static function setReportModel($model)
    {
        static::$models[Report::class] = $model;
    }
    ...
    public static function thread(array $attributes = [])
    {
	 ...
	 public static function report(array $attributes = [])
    {
        return static::make(Report::class, $attributes);
    }
